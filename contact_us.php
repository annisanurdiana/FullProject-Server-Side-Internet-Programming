        ...
        <div class="container"><a class="navbar-brand js-scroll-trigger" data-bs-hover-animate="swing" href="#">Quory</a><button data-toggle="collapse" class="navbar-toggler navbar-toggler-right" data-target="#navbarResponsive" type="button" aria-controls="navbarResponsive"
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item nav-link js-scroll-trigger"><a class="nav-link js-scroll-trigger" data-bs-hover-animate="pulse" href="contact_us.php">Contact</a></li>

                </ul>
            </div><a data-bs-hover-animate="flash" class="js-scroll-trigger" href="login.php">Login </a></div>
    </nav>
    <div class="login-dark">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <div class="form-group">
                ...
                <p>Don't have an account? <a href="#" style="color: #fcf162e5;">Report Here!&nbsp;<br></a></p>
            </div>
            
            <div class="form-group">
                <button class="btn btn-primary btn-block" data-bs-hover-animate="pulse"type="submit"><a style="color: aliceblue;"href="login_admin.php">LOGIN AS ADMIN</a></button>
            </div>    
    </form>
    </div>
